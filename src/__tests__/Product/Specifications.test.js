...
it('Loads one table with one row', () => {
            ...
            specifications={[
                {
                    heading: 'Table One',
                    rows: [
                        ['TableOneRowOneColumnOne', 'TableOneRowOneColumnTwo'],
                    ],
                },
            ]}
        />
    ...
    expect(screen.getAllByRole('heading')[1]).toHaveTextContent('Table One'); // loads table heading
...
it('Loads multiple tables with multiple rows', () => {
            ...
            specifications={[
                {
                    ...
                    rows: [
                        ['TableOneRowOneColumnOne', 'TableOneRowOneColumnTwo'],
                        ['TableOneRowTwoColumnOne', 'TableOneRowTwoColumnTwo'],
                        [
                ...
                },
                {
                    heading: 'Table Two',
                    rows: [
                        ['TableTwoRowOneColumnOne', 'TableTwoRowOneColumnTwo'],
                        ['TableTwoRowTwoColumnOne', 'TableTwoRowTwoColumnTwo'],
                    ],
                },
            ]}
        />
    ...
    expect(screen.getAllByRole('heading')[1]).toHaveTextContent('Table One'); // loads table one heading
    expect(screen.getAllByRole('heading')[2]).toHaveTextContent('Table Two'); // loads table two heading
